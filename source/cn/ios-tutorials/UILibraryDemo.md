---
title: Creating a Simplified DJI Go app using DJI Mobile UI Library
version: v4.0.1
date: 2017-05-05
...
In this tutorial, you will learn how to use DJI iOS UI Library and DJI iOS SDK to create a simplified DJI Go app easily, with standard DJI Go UIs and functionalities. By the end of this tutorial you will have an app that you can use to show the camera FPV view, check aircraft status, shoot photos, preview and download media files and so on.
...
### Import the DJI SDK and UILibrary with CocoaPods
...
If you can see the live video feed and test the features like this, congratulations! Using the DJI UI Library is that easy. Let's move forward.
...
In this tutorial, you have learned how to use DJI iOS UI Library and DJI iOS SDK to create a simplified DJI Go app easily, with standard DJI Go UIs and functionalities. You also learned how to enter camera playback mode to edit media files, download and save photos to the iOS Photo Album. Hope you enjoy it!
